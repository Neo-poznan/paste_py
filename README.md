...
Для хранения текстовых данных также отлично подходит база данных, современные БД хорошо оптимизированы для этого. Существуют даже документ-ориентированные БД, специально для хранения больших объемов текста.
...
#### Получение постов
Когда нужно получить пост, то достаем из базы данных метаданные, а текст поста из файлового хранилища, после чего кэшируем текст на 30 минут.
